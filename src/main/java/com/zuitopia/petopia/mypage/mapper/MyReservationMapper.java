...
public interface MyReservationMapper {
    ...
    ReservationVO getReservationVOByReservationId(int reservationId); // 예약 아이디를 사용해서 예약 1건 가져오기

    List<ReservationVO> getReservationVOList(int userId); // 유저 아이디를 사용해서 예약 1건 가져오기
